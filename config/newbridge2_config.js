/**
 * Configuration module for Bridge geometry validation rules (VERIFIED)
 * Source: TR-514 Road Geometric Design Manual (Second Edition - 2022)
 *         Chapter 7: Rural and Urban Freeways (Sections 7.4)
 *         TR-541-1: Standard Drawing Guideline Part 1
 */

// ============================================================================
// BRIDGE ARTICLES (VERIFIED TR-514 SECTION 7.4)
// ============================================================================
const BRIDGE_ARTICLES = [
    // ============================================================================
    // SECTION 1: BRIDGE VERTICAL CLEARANCES
    // Source: TR-514 Section 7.4.9 (Page 353 Absolute / 341 Printed)
    // ============================================================================
    {
        article_id: "B1",
    ...
    // Source: TR-514 Section 7.4.10 (Page 354 Absolute / 342 Printed)
    // ============================================================================
    {
        article_id: "B2",
...
// ============================================================================
// BRIDGE VERTICAL CLEARANCES LOOKUP (VERIFIED)
// ============================================================================
const VERTICAL_CLEARANCES = {
    ...
    navigable_channel: 8.5,
    sign_gantry_highway: 6.5
};

// ============================================================================
// BRIDGE HORIZONTAL CLEARANCES LOOKUP (VERIFIED)
// ============================================================================
const HORIZONTAL_CLEARANCES = {
    bridge_abutment: 1.5,
    pier_from_lane: 0.6,
    sign_post_high_speed: 9.0
};
...
const SUMMARY = {
    ...
    total_bridge_rules: BRIDGE_ARTICLES.reduce((sum, article) => sum + article.rules.length, 0),
    sources: [
        "TR-514: Road Geometric Design Manual, Second Edition - January 2022 (Verified Sections 7.4)",
        "TR-541-1: Standard Drawing Guideline Part 1"
    ],
    categories: {
        bridges: [
